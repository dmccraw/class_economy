  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update_attributes).with({ "from_account_id" => "" })
        put :update, {:id => transaction.to_param, :transaction => { "from_account_id" => "" }}, valid_session
      end
