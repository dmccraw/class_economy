  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved store as @store" do
        ...
        post :create, {:store => { "group" => "invalid value" }}, valid_session
        assigns(:store).should be_a_new(Store)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested store" do
        ...
        Store.any_instance.should_receive(:update_attributes).with({ "group" => "" })
        put :update, {:id => store.to_param, :store => { "group" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the store as @store" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Store.any_instance.stub(:save).and_return(false)
        put :update, {:id => store.to_param, :store => { "group" => "invalid value" }}, valid_session
        assigns(:store).should eq(store)
      end
